...
public class MyBookAdapter extends RecyclerView.Adapter<MyBookAdapter.BookViewHolder> {
    ...
    public MyBookAdapter(ArrayList<Book> bookInfoArrayList, Context mcontext) {
    ...
    public BookViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.book_delete, parent, false);
    ...
    public void onBindViewHolder(@NonNull BookViewHolder holder, int position) {
        ...
        holder.isbn.setText(bookInfo.getIsbn_10()+"");
        ...
        holder.myButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference mPostReference = FirebaseDatabase.getInstance().getReference(inst.getCurrentUser().getEmail().replace(".",""))
                        .child(holder.isbn.getText()+"");
    ...
    public class BookViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView nameTV, publisherTV, pageCountTV, dateTV, isbn;
        ImageView bookIV;
        Button myButton;
        ...
        public BookViewHolder(View itemView) {
            ...
            isbn = itemView.findViewById(R.id.idTVisbn);
